...
EXTERN_C const IID IID_IModel;
    ...
    MIDL_INTERFACE("ea7ac902-5dc5-4732-b2dc-46f50fd9385b")
    IModel : public IDispatch
    {
    public:
...
#define IModel_Run(This,argv)	\
    ( (This)->lpVtbl -> Run(This,argv) ) 
...
#ifndef __XAJLib_LIBRARY_DEFINED__
#define __XAJLib_LIBRARY_DEFINED__

/* library XAJLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_XAJLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("fb867d6b-4a32-4e2f-addd-3047d0103833")
CompReg;
#endif
...
class DECLSPEC_UUID("e002b0ec-9a5c-44c8-8b96-bb7648d05f25")
Model;
#endif
#endif /* __XAJLib_LIBRARY_DEFINED__ */
