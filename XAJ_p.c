...
typedef struct _XAJ_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } XAJ_MIDL_TYPE_FORMAT_STRING;

typedef struct _XAJ_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } XAJ_MIDL_PROC_FORMAT_STRING;

typedef struct _XAJ_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } XAJ_MIDL_EXPR_FORMAT_STRING;
...
extern const XAJ_MIDL_TYPE_FORMAT_STRING XAJ__MIDL_TypeFormatString;
extern const XAJ_MIDL_PROC_FORMAT_STRING XAJ__MIDL_ProcFormatString;
extern const XAJ_MIDL_EXPR_FORMAT_STRING XAJ__MIDL_ExprFormatString;
...
static const XAJ_MIDL_PROC_FORMAT_STRING XAJ__MIDL_ProcFormatString =
    {
        0,
        {
...
/* 248 */	NdrFcShort( 0xa ),	/* Flags:  must free, in, */
/* 250 */	NdrFcShort( 0x8 ),	/* X64 Stack size/offset = 8 */
/* 252 */	NdrFcShort( 0x4aa ),	/* Type Offset=1194 */
...
static const XAJ_MIDL_TYPE_FORMAT_STRING XAJ__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* 1214 */	NdrFcLong( 0xffffffff ),	/* -1 */
/* 1218 */	NdrFcShort( 0x0 ),	/* Corr flags:  */
/* 1220 */	0x0 , 
			0x0,		/* 0 */
...
/* Object interface: IModel, ver. 0.0,
   GUID={0xea7ac902,0x5dc5,0x4732,{0xb2,0xdc,0x46,0xf5,0x0f,0xd9,0x38,0x5b}} */
...
static const MIDL_SYNTAX_INFO IComponentRegistrar_SyntaxInfo [  2 ] = 
    ...
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    XAJ__MIDL_ProcFormatString.Format,
    &IComponentRegistrar_FormatStringOffsetTable[-3],
    XAJ__MIDL_TypeFormatString.Format,
    UserMarshalRoutines,
    0,
    0
    }
...
#pragma code_seg(".orpc")
static const FormatInfoRef IModel_Ndr64ProcTable[] =
    {
    (FormatInfoRef)(LONG_PTR) -1,
    (FormatInfoRef)(LONG_PTR) -1,
    (FormatInfoRef)(LONG_PTR) -1,
...
static const MIDL_SYNTAX_INFO IModel_SyntaxInfo [  2 ] = 
    {
    {
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    ...
    0,
    0 ,
    (unsigned short *) &IModel_Ndr64ProcTable[-3],
    0,
    NDR64_UserMarshalRoutines,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IModel_ProxyInfo =
    ...
    (RPC_SYNTAX_IDENTIFIER*)&_RpcTransferSyntax,
    2,
    (MIDL_SYNTAX_INFO*)IModel_SyntaxInfo
...
static const MIDL_SERVER_INFO IModel_ServerInfo = 
    ...
    0,
    XAJ__MIDL_ProcFormatString.Format,
    (unsigned short *) &IModel_FormatStringOffsetTable[-3],
    0,
    (RPC_SYNTAX_IDENTIFIER*)&_NDR64_RpcTransferSyntax,
    2,
    (MIDL_SYNTAX_INFO*)IModel_SyntaxInfo
    };
CINTERFACE_PROXY_VTABLE(8) _IModelProxyVtbl = 
{
    &IModel_ProxyInfo,
    &IID_IModel,
    IUnknown_QueryInterface_Proxy,
...
const CInterfaceProxyVtbl * const _XAJ_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * const _XAJ_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IModelStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
...
PCInterfaceName const _XAJ_InterfaceNamesList[] = 
{
    "IModel",
    "IComponentRegistrar",
    0
...
const IID *  const _XAJ_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _XAJ_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _XAJ, pIID, n)

int __stdcall _XAJ_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _XAJ, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _XAJ, 2, *pIndex )
    
}

const ExtendedProxyFileInfo XAJ_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _XAJ_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _XAJ_StubVtblList,
    (const PCInterfaceName * ) & _XAJ_InterfaceNamesList,
    (const IID ** ) & _XAJ_BaseIIDList,
    & _XAJ_IID_Lookup, 
    2,
    2,
